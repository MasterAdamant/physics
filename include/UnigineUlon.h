...
{
public:
	typedef const UlonValue ConstUlonValue;
...
typedef Ptr<const UlonValue> ConstUlonValuePtr;
typedef const UlonValue ConstUlonValue;
...
{
public:
	typedef const UlonArg ConstUlonArg;
	static constexpr bool HAS_OWNERSHIP = true;
...
typedef Ptr<const UlonArg> ConstUlonArgPtr;
typedef const UlonArg ConstUlonArg;
...
{
public:
	typedef const UlonNode ConstUlonNode;
	static constexpr bool HAS_OWNERSHIP = true;
...
typedef Ptr<const UlonNode> ConstUlonNodePtr;
typedef const UlonNode ConstUlonNode;
