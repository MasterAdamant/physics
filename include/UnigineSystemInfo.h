...
public:
	...
	struct MemoryStatistics
	{
		...
		long long free_committed{0};
		long long usage_committed{0};
	};
	struct GPUMemoryStatistics
	{
		long long ram_usage{0};

		long long vram_limit{0};
		long long vram_usage{0};
		long long vram_free{0};
	};

	static MemoryStatistics getMemoryStatistics();
	static GPUMemoryStatistics getGPUMemoryStatistics();
	...
	static long long getGPUMemoryLimit();
