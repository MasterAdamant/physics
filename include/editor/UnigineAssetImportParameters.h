...
{
public:
	typedef const LandscapeMapImportParameters ConstLandscapeMapImportParameters;
	...
	/// <summary> Sets a value indicating if lossy compression for the Heightmap data of the Landscape Layer Map is enabled. </summary>
	/// <param name='compression'> <b>true</b> - to enable lossy compression for the Heightmap data, <b>false</b> - to use lossless compression (Jackalless method).</param>
	void setHeightmapLossyCompression(bool compression);
	/// <summary> Returns a value indicating if lossy compression for the Heightmap data of the Landscape Layer Map is enabled. </summary>
	bool isHeightmapLossyCompression() const;
...
typedef Unigine::Ptr<const LandscapeMapImportParameters> ConstLandscapeMapImportParametersPtr;
typedef const LandscapeMapImportParameters ConstLandscapeMapImportParameters;
