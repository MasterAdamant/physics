...
/// <summary>This class is used to manage shortcuts (hotkeys). The shortcut can be set up to contain all the key presses necessary to describe a keyboard and mouse input combination, including the states of modifier keys such as Shift, Ctrl, Alt, Cmd as well as mouse buttons.
...
{
public:
	typedef const Shortcut ConstShortcut;
...
typedef Unigine::Ptr<const Shortcut> ConstShortcutPtr;
typedef const Shortcut ConstShortcut;


/// <summary>This class is used to manage a shortcut context (add, remove shortcuts, define interaction with other contexts).
...
{
public:
	typedef const ShortcutContext ConstShortcutContext;
	static constexpr bool HAS_OWNERSHIP = false;
...
typedef Unigine::Ptr<const ShortcutContext> ConstShortcutContextPtr;
typedef const ShortcutContext ConstShortcutContext;

//////////////////////////////////////////////////////////////////////////

/// <summary>This class is used to manage all shortcuts (hotkeys and combinations) and shortcut contexts that you usually see in Windows - Settings - Hotkeys.
/// Warning: this class is NOT THREAD-SAFE, you should call its methods FROM THE MAIN THREAD ONLY.
/// </summary>
