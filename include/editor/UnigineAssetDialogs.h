...
public:
	...
	enum class DialogMode
	{
		...
		Modal,
		/// <summary>Modal non-blocking dialog, which stays on the screen and is available for use at any time but permits other user activities (the function returns control right after creating and displaying the dialog).</summary>
		ModalNonBlocking,
		/// <summary>Modeless dialog, which stays on the screen and is available for use at any time and does not permit other user activities (the function returns control right after creating and displaying the dialog).</summary>
		Modeless
	};
