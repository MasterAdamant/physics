...
{
public:
	typedef const MountPointParameters ConstMountPointParameters;
	...
	void addGuidsDBIgnoreFilter(const char *ignore_filter);
	Unigine::Vector<Unigine::String> getGuidsDBIgnoreFilters() const;
	void getGuidsDBIgnoreFilters(Unigine::Vector<Unigine::String> &ignore_filters) const;
};
typedef Unigine::Ptr<MountPointParameters> MountPointParametersPtr;
typedef Unigine::Ptr<const MountPointParameters> ConstMountPointParametersPtr;
typedef const MountPointParameters ConstMountPointParameters;
