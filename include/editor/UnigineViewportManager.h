...
/// <summary> Viewport manager class. This class is used to create, manage, and remove all viewports in the Editor.
...
/// <summary> This class is used to manage viewport windows in the Editor.
...
{
public:
	typedef const ViewportWindow ConstViewportWindow;
...
typedef Unigine::Ptr<const ViewportWindow> ConstViewportWindowPtr;
typedef const ViewportWindow ConstViewportWindow;
