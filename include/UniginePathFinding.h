...
{
public:
	typedef const Navigation ConstNavigation;
	...
	bool inside2D(const Math::Vec3 &point, float radius) const;
	bool inside3D(const Math::Vec3 &point, float radius) const;
	bool inside(const Ptr<Navigation> &navigation) const;
};
typedef Ptr<Navigation> NavigationPtr;
typedef Ptr<const Navigation> ConstNavigationPtr;
typedef const Navigation ConstNavigation;
...
{
public:
	typedef const NavigationMesh ConstNavigationMesh;
...
typedef Ptr<const NavigationMesh> ConstNavigationMeshPtr;
typedef const NavigationMesh ConstNavigationMesh;
...
{
public:
	typedef const NavigationSector ConstNavigationSector;
...
typedef Ptr<const NavigationSector> ConstNavigationSectorPtr;
typedef const NavigationSector ConstNavigationSector;
...
{
public:
	typedef const Obstacle ConstObstacle;
...
typedef Ptr<const Obstacle> ConstObstaclePtr;
typedef const Obstacle ConstObstacle;
...
{
public:
	typedef const ObstacleBox ConstObstacleBox;
...
typedef Ptr<const ObstacleBox> ConstObstacleBoxPtr;
typedef const ObstacleBox ConstObstacleBox;
...
{
public:
	typedef const ObstacleCapsule ConstObstacleCapsule;
...
typedef Ptr<const ObstacleCapsule> ConstObstacleCapsulePtr;
typedef const ObstacleCapsule ConstObstacleCapsule;
...
{
public:
	typedef const ObstacleSphere ConstObstacleSphere;
...
typedef Ptr<const ObstacleSphere> ConstObstacleSpherePtr;
typedef const ObstacleSphere ConstObstacleSphere;
...
{
public:
	typedef const PathRoute ConstPathRoute;
...
typedef Ptr<const PathRoute> ConstPathRoutePtr;
typedef const PathRoute ConstPathRoute;
...
{
public:
	typedef const PathRouteIntersection ConstPathRouteIntersection;
...
typedef Ptr<const PathRouteIntersection> ConstPathRouteIntersectionPtr;
typedef const PathRouteIntersection ConstPathRouteIntersection;
