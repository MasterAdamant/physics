...
{
public:
	typedef const VRMarkerObject ConstVRMarkerObject;
...
typedef Ptr<const VRMarkerObject> ConstVRMarkerObjectPtr;
typedef const VRMarkerObject ConstVRMarkerObject;
...
public:
	...
	static bool hasFeatureChromakey();
	static bool hasFeatureAlphaBlend();
	static bool hasFeatureDepthTest();
	static bool hasFeatureDepthTestRange();
	static bool hasFeatureBlendmasking();
	static bool hasFeatureCameraProperties();
	static bool hasFeatureMarkerTracking();
	static bool hasFeatureViewOffset();
	static bool hasFeatureColorCorrection();
	static bool hasFeatureEnvironmentCubemap();
	...
	{
		CAMERA_FLICKER_COMPENSATION_UNKNOWN,
