...
typedef Ptr<const Image> ConstImagePtr;
typedef const Image ConstImage;
...
{
public:
	typedef const ImageConverter ConstImageConverter;
	static constexpr bool HAS_OWNERSHIP = true;
...
typedef Ptr<const ImageConverter> ConstImageConverterPtr;
typedef const ImageConverter ConstImageConverter;
