...
{
public:
	typedef const PhysicsIntersection ConstPhysicsIntersection;
...
typedef Ptr<const PhysicsIntersection> ConstPhysicsIntersectionPtr;
typedef const PhysicsIntersection ConstPhysicsIntersection;
...
{
public:
typedef const PhysicsIntersectionNormal ConstPhysicsIntersectionNormal;
...
typedef Ptr<const PhysicsIntersectionNormal> ConstPhysicsIntersectionNormalPtr;
typedef const PhysicsIntersectionNormal ConstPhysicsIntersectionNormal;
...
{
public:
	typedef const ShapeContact ConstShapeContact;
	static constexpr bool HAS_OWNERSHIP = true;
...
typedef Ptr<const ShapeContact> ConstShapeContactPtr;
typedef const ShapeContact ConstShapeContact;
...
{
public:
	typedef const Shape ConstShape;
...
typedef Ptr<const Shape> ConstShapePtr;
typedef const Shape ConstShape;
...
{
public:
typedef const ShapeSphere ConstShapeSphere;
...
typedef Ptr<const ShapeSphere> ConstShapeSpherePtr;
typedef const ShapeSphere ConstShapeSphere;
...
{
public:
typedef const ShapeCapsule ConstShapeCapsule;
...
typedef Ptr<const ShapeCapsule> ConstShapeCapsulePtr;
typedef const ShapeCapsule ConstShapeCapsule;
...
{
public:
typedef const ShapeCylinder ConstShapeCylinder;
...
typedef Ptr<const ShapeCylinder> ConstShapeCylinderPtr;
typedef const ShapeCylinder ConstShapeCylinder;
...
{
public:
typedef const ShapeBox ConstShapeBox;
...
typedef Ptr<const ShapeBox> ConstShapeBoxPtr;
typedef const ShapeBox ConstShapeBox;
...
{
public:
typedef const ShapeConvex ConstShapeConvex;
...
typedef Ptr<const ShapeConvex> ConstShapeConvexPtr;
typedef const ShapeConvex ConstShapeConvex;
...
{
public:
	typedef const Joint ConstJoint;
	static constexpr bool HAS_OWNERSHIP = false;
...
typedef Ptr<const Joint> ConstJointPtr;
typedef const Joint ConstJoint;
...
{
public:
typedef const JointFixed ConstJointFixed;
...
typedef Ptr<const JointFixed> ConstJointFixedPtr;
typedef const JointFixed ConstJointFixed;
...
{
public:
typedef const JointBall ConstJointBall;
...
typedef Ptr<const JointBall> ConstJointBallPtr;
typedef const JointBall ConstJointBall;
...
{
public:
typedef const JointCylindrical ConstJointCylindrical;
...
typedef Ptr<const JointCylindrical> ConstJointCylindricalPtr;
typedef const JointCylindrical ConstJointCylindrical;
...
{
public:
typedef const JointHinge ConstJointHinge;
...
typedef Ptr<const JointHinge> ConstJointHingePtr;
typedef const JointHinge ConstJointHinge;
...
{
public:
typedef const JointParticles ConstJointParticles;
...
typedef Ptr<const JointParticles> ConstJointParticlesPtr;
typedef const JointParticles ConstJointParticles;
...
{
public:
typedef const JointPath ConstJointPath;
...
typedef Ptr<const JointPath> ConstJointPathPtr;
typedef const JointPath ConstJointPath;
...
{
public:
typedef const JointPrismatic ConstJointPrismatic;
...
typedef Ptr<const JointPrismatic> ConstJointPrismaticPtr;
typedef const JointPrismatic ConstJointPrismatic;
...
{
public:
typedef const JointSuspension ConstJointSuspension;
...
typedef Ptr<const JointSuspension> ConstJointSuspensionPtr;
typedef const JointSuspension ConstJointSuspension;
...
{
public:
typedef const JointWheel ConstJointWheel;
...
typedef Ptr<const JointWheel> ConstJointWheelPtr;
typedef const JointWheel ConstJointWheel;
...
typedef Ptr<const Body> ConstBodyPtr;
typedef const Body ConstBody;
...
{
public:
typedef const BodyDummy ConstBodyDummy;
...
typedef Ptr<const BodyDummy> ConstBodyDummyPtr;
typedef const BodyDummy ConstBodyDummy;
...
{
public:
typedef const BodyRigid ConstBodyRigid;
...
typedef Ptr<const BodyRigid> ConstBodyRigidPtr;
typedef const BodyRigid ConstBodyRigid;
...
{
public:
typedef const BodyFracture ConstBodyFracture;
...
typedef Ptr<const BodyFracture> ConstBodyFracturePtr;
typedef const BodyFracture ConstBodyFracture;
...
{
public:
typedef const BodyPath ConstBodyPath;
...
typedef Ptr<const BodyPath> ConstBodyPathPtr;
typedef const BodyPath ConstBodyPath;
...
{
public:
typedef const BodyRagdoll ConstBodyRagdoll;
...
typedef Ptr<const BodyRagdoll> ConstBodyRagdollPtr;
typedef const BodyRagdoll ConstBodyRagdoll;
...
{
public:
typedef const BodyWater ConstBodyWater;
...
typedef Ptr<const BodyWater> ConstBodyWaterPtr;
typedef const BodyWater ConstBodyWater;
...
{
public:
typedef const BodyParticles ConstBodyParticles;
...
typedef Ptr<const BodyParticles> ConstBodyParticlesPtr;
typedef const BodyParticles ConstBodyParticles;
...
{
public:
typedef const BodyCloth ConstBodyCloth;
...
typedef Ptr<const BodyCloth> ConstBodyClothPtr;
typedef const BodyCloth ConstBodyCloth;
...
{
public:
typedef const BodyRope ConstBodyRope;
...
typedef Ptr<const BodyRope> ConstBodyRopePtr;
typedef const BodyRope ConstBodyRope;
