...
{
public:
	typedef const InputGamePad ConstInputGamePad;
...
typedef Ptr<const InputGamePad> ConstInputGamePadPtr;
typedef const InputGamePad ConstInputGamePad;
...
{
public:
	typedef const InputVRDevice ConstInputVRDevice;
	static constexpr bool HAS_OWNERSHIP = false;
...
typedef Ptr<const InputVRDevice> ConstInputVRDevicePtr;
typedef const InputVRDevice ConstInputVRDevice;
...
{
public:
typedef const InputVRHead ConstInputVRHead;
...
typedef Ptr<const InputVRHead> ConstInputVRHeadPtr;
typedef const InputVRHead ConstInputVRHead;
...
{
public:
typedef const InputVRTracker ConstInputVRTracker;
...
typedef Ptr<const InputVRTracker> ConstInputVRTrackerPtr;
typedef const InputVRTracker ConstInputVRTracker;
...
{
public:
typedef const InputVRBaseStation ConstInputVRBaseStation;
...
typedef Ptr<const InputVRBaseStation> ConstInputVRBaseStationPtr;
typedef const InputVRBaseStation ConstInputVRBaseStation;
...
{
public:
typedef const InputVRController ConstInputVRController;
...
typedef Ptr<const InputVRController> ConstInputVRControllerPtr;
typedef const InputVRController ConstInputVRController;
...
{
public:
	typedef const InputJoystick ConstInputJoystick;
	static constexpr bool HAS_OWNERSHIP = false;
...
typedef Ptr<const InputJoystick> ConstInputJoystickPtr;
typedef const InputJoystick ConstInputJoystick;
...
{
public:
	typedef const InputEvent ConstInputEvent;
...
typedef Ptr<const InputEvent> ConstInputEventPtr;
typedef const InputEvent ConstInputEvent;
...
{
public:
typedef const InputEventMouseButton ConstInputEventMouseButton;
...
typedef Ptr<const InputEventMouseButton> ConstInputEventMouseButtonPtr;
typedef const InputEventMouseButton ConstInputEventMouseButton;
...
{
public:
typedef const InputEventMouseWheel ConstInputEventMouseWheel;
...
typedef Ptr<const InputEventMouseWheel> ConstInputEventMouseWheelPtr;
typedef const InputEventMouseWheel ConstInputEventMouseWheel;
...
{
public:
typedef const InputEventMouseMotion ConstInputEventMouseMotion;
...
typedef Ptr<const InputEventMouseMotion> ConstInputEventMouseMotionPtr;
typedef const InputEventMouseMotion ConstInputEventMouseMotion;
...
{
public:
typedef const InputEventKeyboard ConstInputEventKeyboard;
...
typedef Ptr<const InputEventKeyboard> ConstInputEventKeyboardPtr;
typedef const InputEventKeyboard ConstInputEventKeyboard;
...
{
public:
typedef const InputEventText ConstInputEventText;
...
typedef Ptr<const InputEventText> ConstInputEventTextPtr;
typedef const InputEventText ConstInputEventText;
...
{
public:
typedef const InputEventTouch ConstInputEventTouch;
...
typedef Ptr<const InputEventTouch> ConstInputEventTouchPtr;
typedef const InputEventTouch ConstInputEventTouch;
...
{
public:
typedef const InputEventJoyDevice ConstInputEventJoyDevice;
...
typedef Ptr<const InputEventJoyDevice> ConstInputEventJoyDevicePtr;
typedef const InputEventJoyDevice ConstInputEventJoyDevice;
...
{
public:
typedef const InputEventJoyButton ConstInputEventJoyButton;
...
typedef Ptr<const InputEventJoyButton> ConstInputEventJoyButtonPtr;
typedef const InputEventJoyButton ConstInputEventJoyButton;
...
{
public:
typedef const InputEventJoyAxisMotion ConstInputEventJoyAxisMotion;
...
typedef Ptr<const InputEventJoyAxisMotion> ConstInputEventJoyAxisMotionPtr;
typedef const InputEventJoyAxisMotion ConstInputEventJoyAxisMotion;
...
{
public:
typedef const InputEventJoyPovMotion ConstInputEventJoyPovMotion;
...
typedef Ptr<const InputEventJoyPovMotion> ConstInputEventJoyPovMotionPtr;
typedef const InputEventJoyPovMotion ConstInputEventJoyPovMotion;
...
{
public:
typedef const InputEventPadDevice ConstInputEventPadDevice;
...
typedef Ptr<const InputEventPadDevice> ConstInputEventPadDevicePtr;
typedef const InputEventPadDevice ConstInputEventPadDevice;
...
{
public:
typedef const InputEventPadButton ConstInputEventPadButton;
...
typedef Ptr<const InputEventPadButton> ConstInputEventPadButtonPtr;
typedef const InputEventPadButton ConstInputEventPadButton;
...
{
public:
typedef const InputEventPadAxisMotion ConstInputEventPadAxisMotion;
...
typedef Ptr<const InputEventPadAxisMotion> ConstInputEventPadAxisMotionPtr;
typedef const InputEventPadAxisMotion ConstInputEventPadAxisMotion;
...
{
public:
typedef const InputEventPadTouchMotion ConstInputEventPadTouchMotion;
...
typedef Ptr<const InputEventPadTouchMotion> ConstInputEventPadTouchMotionPtr;
typedef const InputEventPadTouchMotion ConstInputEventPadTouchMotion;
...
{
public:
typedef const InputEventVRDevice ConstInputEventVRDevice;
...
typedef Ptr<const InputEventVRDevice> ConstInputEventVRDevicePtr;
typedef const InputEventVRDevice ConstInputEventVRDevice;
...
{
public:
typedef const InputEventVRButton ConstInputEventVRButton;
...
typedef Ptr<const InputEventVRButton> ConstInputEventVRButtonPtr;
typedef const InputEventVRButton ConstInputEventVRButton;
...
{
public:
typedef const InputEventVRButtonTouch ConstInputEventVRButtonTouch;
...
typedef Ptr<const InputEventVRButtonTouch> ConstInputEventVRButtonTouchPtr;
typedef const InputEventVRButtonTouch ConstInputEventVRButtonTouch;
...
{
public:
typedef const InputEventVRAxisMotion ConstInputEventVRAxisMotion;
...
typedef Ptr<const InputEventVRAxisMotion> ConstInputEventVRAxisMotionPtr;
typedef const InputEventVRAxisMotion ConstInputEventVRAxisMotion;
...
{
public:
typedef const InputEventSystem ConstInputEventSystem;
...
typedef Ptr<const InputEventSystem> ConstInputEventSystemPtr;
typedef const InputEventSystem ConstInputEventSystem;
