...
UNIGINE_INLINE ivec2 align(const ivec2 &v, const ivec2 &v_align) { return {align(v.x, v_align.x), align(v.y, v_align.y)}; }
UNIGINE_INLINE ivec2 align(const ivec2 &v, int v_align) { return {align(v.x, v_align), align(v.y, v_align)}; }
