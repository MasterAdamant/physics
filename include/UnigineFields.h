...
typedef Ptr<const Field> ConstFieldPtr;
typedef const Field ConstField;
...
{
public:
	typedef const FieldAnimation ConstFieldAnimation;
...
typedef Ptr<const FieldAnimation> ConstFieldAnimationPtr;
typedef const FieldAnimation ConstFieldAnimation;
...
{
public:
	typedef const FieldHeight ConstFieldHeight;
...
typedef Ptr<const FieldHeight> ConstFieldHeightPtr;
typedef const FieldHeight ConstFieldHeight;
...
{
public:
	typedef const FieldWeather ConstFieldWeather;
...
typedef Ptr<const FieldWeather> ConstFieldWeatherPtr;
typedef const FieldWeather ConstFieldWeather;
...
{
public:
	typedef const FieldShoreline ConstFieldShoreline;
...
typedef Ptr<const FieldShoreline> ConstFieldShorelinePtr;
typedef const FieldShoreline ConstFieldShoreline;
...
{
public:
	typedef const FieldSpacer ConstFieldSpacer;
...
typedef Ptr<const FieldSpacer> ConstFieldSpacerPtr;
typedef const FieldSpacer ConstFieldSpacer;
