...
{
public:
	typedef const Controls ConstControls;
...
typedef Ptr<const Controls> ConstControlsPtr;
typedef const Controls ConstControls;
...
{
public:
typedef const ControlsDummy ConstControlsDummy;
...
typedef Ptr<const ControlsDummy> ConstControlsDummyPtr;
typedef const ControlsDummy ConstControlsDummy;
