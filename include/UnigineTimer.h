...
public:
	...
	UNIGINE_INLINE static double nanosecondsToMicroseconds(long long nanoseconds) { return nanoseconds / 1'000.0; }
	UNIGINE_INLINE static double nanosecondsToMilliseconds(long long nanoseconds) { return nanoseconds / 1'000'000.0; }
	UNIGINE_INLINE static double nanosecondsToSeconds(long long nanoseconds) { return nanoseconds / 1'000'000'000.0; }
	...
	UNIGINE_INLINE static double microsecondsToMilliseconds(long long microseconds) { return (double)(microseconds * 1'000) / (double)CLOCKS_PER_SECOND; }
	UNIGINE_INLINE static double microsecondsToSeconds(long long microseconds) { return (double)microseconds / (double)CLOCKS_PER_SECOND; }
