...
{
public:
	typedef const WorldIntersection ConstWorldIntersection;
...
typedef Ptr<const WorldIntersection> ConstWorldIntersectionPtr;
typedef const WorldIntersection ConstWorldIntersection;
...
{
public:
typedef const WorldIntersectionNormal ConstWorldIntersectionNormal;
...
typedef Ptr<const WorldIntersectionNormal> ConstWorldIntersectionNormalPtr;
typedef const WorldIntersectionNormal ConstWorldIntersectionNormal;
...
{
public:
typedef const WorldIntersectionTexCoord ConstWorldIntersectionTexCoord;
...
typedef Ptr<const WorldIntersectionTexCoord> ConstWorldIntersectionTexCoordPtr;
typedef const WorldIntersectionTexCoord ConstWorldIntersectionTexCoord;
...
{
public:
	typedef const WorldExtern ConstWorldExtern;
...
typedef Ptr<const WorldExtern> ConstWorldExternPtr;
typedef const WorldExtern ConstWorldExtern;
...
{
public:
typedef const WorldExternBase ConstWorldExternBase;
	WorldExternBase();
...
typedef Ptr<const WorldExternBase> ConstWorldExternBasePtr;
typedef const WorldExternBase ConstWorldExternBase;
