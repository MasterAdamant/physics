...
template <class Type, class A0, class A1>
UNIGINE_INLINE void quickSort(Unigine::Vector<Type> &array, int (*func)(A0, A1))
{
	quick_sort_function_compare<Type, int (*)(A0, A1)> compare(func);
	quick_sort<Type, Type, quick_sort_function_compare<Type, int (*)(A0, A1)>, false>(array.get(), array.size(), compare, NULL);
}
