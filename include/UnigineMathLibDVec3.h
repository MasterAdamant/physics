...
struct alignas(16) dvec3
{
	...
	UNIGINE_INLINE double minXY() const { return Math::min(x, y); }
	/// <summary>Compares all components of the vector and returns the smallest value.</summary>
	UNIGINE_INLINE double min() const { return Math::min(minXY(), z); }
...
UNIGINE_INLINE bool compare(const dvec3 &v0, const dvec3 &v1)
{
...
UNIGINE_INLINE bool compare(const dvec3 &v0, const dvec3 &v1, double eps)
{
	return (compare(v0.x, v1.x, eps) && compare(v0.y, v1.y, eps) && compare(v0.z, v1.z, eps));
}
/// <summary>Vector equal comparison.</summary>
UNIGINE_INLINE bool operator==(const dvec3 &v0, const dvec3 &v1) { return compare(v0, v1); }
/// <summary>Vector not equal comparison.</summary>
UNIGINE_INLINE bool operator!=(const dvec3 &v0, const dvec3 &v1) { return !compare(v0, v1); }

/// <summary>Vector less than comparison.</summary>
UNIGINE_INLINE bool operator<(const dvec3 &v0, const dvec3 &v1) { return v0.x < v1.x &&v0.y < v1.y &&v0.z < v1.z; }
