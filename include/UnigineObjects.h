...
{
public:
	typedef const ObjectIntersection ConstObjectIntersection;
...
typedef Ptr<const ObjectIntersection> ConstObjectIntersectionPtr;
typedef const ObjectIntersection ConstObjectIntersection;
...
{
public:
typedef const ObjectIntersectionNormal ConstObjectIntersectionNormal;
...
typedef Ptr<const ObjectIntersectionNormal> ConstObjectIntersectionNormalPtr;
typedef const ObjectIntersectionNormal ConstObjectIntersectionNormal;
...
{
public:
typedef const ObjectIntersectionTexCoord ConstObjectIntersectionTexCoord;
...
typedef Ptr<const ObjectIntersectionTexCoord> ConstObjectIntersectionTexCoordPtr;
typedef const ObjectIntersectionTexCoord ConstObjectIntersectionTexCoord;
...
typedef Ptr<const Object> ConstObjectPtr;
typedef const Object ConstObject;
...
{
public:
	typedef const ObjectDummy ConstObjectDummy;
...
typedef Ptr<const ObjectDummy> ConstObjectDummyPtr;
typedef const ObjectDummy ConstObjectDummy;
...
{
public:
	typedef const ObjectDynamic ConstObjectDynamic;
...
typedef Ptr<const ObjectDynamic> ConstObjectDynamicPtr;
typedef const ObjectDynamic ConstObjectDynamic;
...
{
public:
	typedef const ObjectMeshStatic ConstObjectMeshStatic;
...
typedef Ptr<const ObjectMeshStatic> ConstObjectMeshStaticPtr;
typedef const ObjectMeshStatic ConstObjectMeshStatic;
...
{
public:
	typedef const BonesRetargeting ConstBonesRetargeting;
	static constexpr bool HAS_OWNERSHIP = true;
	...
	bool loadBonesFromMeshes(const Ptr<ConstMesh> &src_mesh, const Ptr<ConstMesh> &dst_mesh);
...
typedef Ptr<const BonesRetargeting> ConstBonesRetargetingPtr;
typedef const BonesRetargeting ConstBonesRetargeting;
...
{
public:
	typedef const ObjectMeshSkinned ConstObjectMeshSkinned;
	...
	bool applyMeshProcedural(const Ptr<ConstMesh> &mesh);
...
typedef Ptr<const ObjectMeshSkinned> ConstObjectMeshSkinnedPtr;
typedef const ObjectMeshSkinned ConstObjectMeshSkinned;
...
{
public:
	typedef const ObjectMeshDynamic ConstObjectMeshDynamic;

	static Node::TYPE type() { return Node::OBJECT_MESH_DYNAMIC; }
	static bool convertible(Node *node) { return (node && node->getType() == type()); }

	static Ptr<ObjectMeshDynamic> create(const Ptr<ConstMesh> &mesh, int flags = 0);
...
typedef Ptr<const ObjectMeshDynamic> ConstObjectMeshDynamicPtr;
typedef const ObjectMeshDynamic ConstObjectMeshDynamic;
...
{
public:
	typedef const ObjectMeshCluster ConstObjectMeshCluster;
...
typedef Ptr<const ObjectMeshCluster> ConstObjectMeshClusterPtr;
typedef const ObjectMeshCluster ConstObjectMeshCluster;
...
{
public:
	typedef const ObjectMeshClutter ConstObjectMeshClutter;
...
typedef Ptr<const ObjectMeshClutter> ConstObjectMeshClutterPtr;
typedef const ObjectMeshClutter ConstObjectMeshClutter;
...
{
public:
	typedef const ObjectMeshSplineCluster ConstObjectMeshSplineCluster;
...
typedef Ptr<const ObjectMeshSplineCluster> ConstObjectMeshSplineClusterPtr;
typedef const ObjectMeshSplineCluster ConstObjectMeshSplineCluster;
...
{
public:
	typedef const ObjectSky ConstObjectSky;
...
typedef Ptr<const ObjectSky> ConstObjectSkyPtr;
typedef const ObjectSky ConstObjectSky;
...
{
public:
	typedef const ObjectGrass ConstObjectGrass;
	...
	void setMaskMaxValue(int value);
	int getMaskMaxValue() const;
	int setMaskMesh(const Ptr<ConstMesh> &mesh, int invalidate = 1);
	int getMaskMesh(const Ptr<Mesh> &mesh) const;
...
typedef Ptr<const ObjectGrass> ConstObjectGrassPtr;
typedef const ObjectGrass ConstObjectGrass;
...
{
public:
	typedef const TerrainDetail ConstTerrainDetail;
...
typedef Ptr<const TerrainDetail> ConstTerrainDetailPtr;
typedef const TerrainDetail ConstTerrainDetail;
...
{
public:
	typedef const TerrainDetailMask ConstTerrainDetailMask;
	static constexpr bool HAS_OWNERSHIP = false;
...
typedef Ptr<const TerrainDetailMask> ConstTerrainDetailMaskPtr;
typedef const TerrainDetailMask ConstTerrainDetailMask;
...
{
public:
	typedef const ObjectLandscapeTerrain ConstObjectLandscapeTerrain;
	...
	static size_t getDetailVideoMemoryUsage();
	static int getNumReloadTiles();
	static int getNumReloadBounds();
	static bool isReloading();
	static bool isReloading(const Math::WorldBoundBox &bb);
};
typedef Ptr<ObjectLandscapeTerrain> ObjectLandscapeTerrainPtr;
typedef Ptr<const ObjectLandscapeTerrain> ConstObjectLandscapeTerrainPtr;
typedef const ObjectLandscapeTerrain ConstObjectLandscapeTerrain;
...
{
public:
	typedef const LandscapeImages ConstLandscapeImages;
	static constexpr bool HAS_OWNERSHIP = true;
...
typedef Ptr<const LandscapeImages> ConstLandscapeImagesPtr;
typedef const LandscapeImages ConstLandscapeImages;
...
{
public:
	typedef const LandscapeTextures ConstLandscapeTextures;
	static constexpr bool HAS_OWNERSHIP = true;
...
typedef Ptr<const LandscapeTextures> ConstLandscapeTexturesPtr;
typedef const LandscapeTextures ConstLandscapeTextures;
...
public:
	...
	static void asyncTextureDraw(int operation_id, const UGUID &file_guid, const Math::ivec2 &coord, const Math::ivec2 &resolution, int flags_file_data, const Vector<Math::WorldBoundBox> &bounds_preload_lmaps, const Vector<Math::WorldBoundBox> &bounds_preload_vtexutres);
	static void asyncTextureDraw(int operation_id, const UGUID &file_guid, const Math::ivec2 &coord, const Math::ivec2 &resolution, int flags_file_data, const Vector<Math::WorldBoundBox> &bounds_preload_lmaps);
	...
	static void asyncTextureDraw(const UGUID &file_guid, const Math::ivec2 &coord, const Math::ivec2 &resolution, int flags_file_data, const Vector<Math::WorldBoundBox> &bounds_preload_lmaps, const Vector<Math::WorldBoundBox> &bounds_preload_vtexutres);
	static void asyncTextureDraw(const UGUID &file_guid, const Math::ivec2 &coord, const Math::ivec2 &resolution, int flags_file_data, const Vector<Math::WorldBoundBox> &bounds_preload_lmaps);
	...
	static void asyncResetModifications(int operation_id, const UGUID &file_guid);
	static void asyncResetModifications(const UGUID &file_guid);
...
{
public:
	typedef const LandscapeLayerMap ConstLandscapeLayerMap;
...
typedef Ptr<const LandscapeLayerMap> ConstLandscapeLayerMapPtr;
typedef const LandscapeLayerMap ConstLandscapeLayerMap;
...
{
public:
	typedef const LandscapeMapFileSettings ConstLandscapeMapFileSettings;
	static constexpr bool HAS_OWNERSHIP = true;
...
typedef Ptr<const LandscapeMapFileSettings> ConstLandscapeMapFileSettingsPtr;
typedef const LandscapeMapFileSettings ConstLandscapeMapFileSettings;
...
{
public:
	typedef const LandscapeMapFileCompression ConstLandscapeMapFileCompression;
	static constexpr bool HAS_OWNERSHIP = true;
...
typedef Ptr<const LandscapeMapFileCompression> ConstLandscapeMapFileCompressionPtr;
typedef const LandscapeMapFileCompression ConstLandscapeMapFileCompression;
...
{
public:
	typedef const LandscapeFetch ConstLandscapeFetch;
	static constexpr bool HAS_OWNERSHIP = true;
...
typedef Ptr<const LandscapeFetch> ConstLandscapeFetchPtr;
typedef const LandscapeFetch ConstLandscapeFetch;
...
{
public:
	typedef const LandscapeMapFileCreator ConstLandscapeMapFileCreator;
	static constexpr bool HAS_OWNERSHIP = true;
...
typedef Ptr<const LandscapeMapFileCreator> ConstLandscapeMapFileCreatorPtr;
typedef const LandscapeMapFileCreator ConstLandscapeMapFileCreator;
...
{
public:
	typedef const TerrainGlobalLod ConstTerrainGlobalLod;
	static constexpr bool HAS_OWNERSHIP = false;
...
typedef Ptr<const TerrainGlobalLod> ConstTerrainGlobalLodPtr;
typedef const TerrainGlobalLod ConstTerrainGlobalLod;
...
{
public:
typedef const TerrainGlobalLodHeight ConstTerrainGlobalLodHeight;
...
typedef Ptr<const TerrainGlobalLodHeight> ConstTerrainGlobalLodHeightPtr;
typedef const TerrainGlobalLodHeight ConstTerrainGlobalLodHeight;
...
{
public:
	typedef const TerrainGlobalLods ConstTerrainGlobalLods;
	static constexpr bool HAS_OWNERSHIP = false;
...
typedef Ptr<const TerrainGlobalLods> ConstTerrainGlobalLodsPtr;
typedef const TerrainGlobalLods ConstTerrainGlobalLods;
...
{
public:
	typedef const TerrainGlobalDetail ConstTerrainGlobalDetail;
	static constexpr bool HAS_OWNERSHIP = false;
...
typedef Ptr<const TerrainGlobalDetail> ConstTerrainGlobalDetailPtr;
typedef const TerrainGlobalDetail ConstTerrainGlobalDetail;
...
{
public:
	typedef const ObjectTerrainGlobal ConstObjectTerrainGlobal;
...
typedef Ptr<const ObjectTerrainGlobal> ConstObjectTerrainGlobalPtr;
typedef const ObjectTerrainGlobal ConstObjectTerrainGlobal;
...
{
public:
	typedef const ParticleModifier ConstParticleModifier;
	static constexpr bool HAS_OWNERSHIP = false;
...
typedef Ptr<const ParticleModifier> ConstParticleModifierPtr;
typedef const ParticleModifier ConstParticleModifier;
...
{
public:
typedef const ParticleModifierScalar ConstParticleModifierScalar;
...
typedef Ptr<const ParticleModifierScalar> ConstParticleModifierScalarPtr;
typedef const ParticleModifierScalar ConstParticleModifierScalar;
...
{
public:
typedef const ParticleModifierVector ConstParticleModifierVector;
...
typedef Ptr<const ParticleModifierVector> ConstParticleModifierVectorPtr;
typedef const ParticleModifierVector ConstParticleModifierVector;
...
{
public:
	typedef const ObjectParticles ConstObjectParticles;
...
typedef Ptr<const ObjectParticles> ConstObjectParticlesPtr;
typedef const ObjectParticles ConstObjectParticles;
...
{
public:
	typedef const ObjectBillboards ConstObjectBillboards;
...
typedef Ptr<const ObjectBillboards> ConstObjectBillboardsPtr;
typedef const ObjectBillboards ConstObjectBillboards;
...
{
public:
	typedef const ObjectVolumeBox ConstObjectVolumeBox;
...
typedef Ptr<const ObjectVolumeBox> ConstObjectVolumeBoxPtr;
typedef const ObjectVolumeBox ConstObjectVolumeBox;
...
{
public:
	typedef const ObjectVolumeSphere ConstObjectVolumeSphere;
...
typedef Ptr<const ObjectVolumeSphere> ConstObjectVolumeSpherePtr;
typedef const ObjectVolumeSphere ConstObjectVolumeSphere;
...
{
public:
	typedef const ObjectVolumeOmni ConstObjectVolumeOmni;
...
typedef Ptr<const ObjectVolumeOmni> ConstObjectVolumeOmniPtr;
typedef const ObjectVolumeOmni ConstObjectVolumeOmni;
...
{
public:
	typedef const ObjectVolumeProj ConstObjectVolumeProj;
...
typedef Ptr<const ObjectVolumeProj> ConstObjectVolumeProjPtr;
typedef const ObjectVolumeProj ConstObjectVolumeProj;
...
{
public:
	typedef const ObjectGui ConstObjectGui;
...
typedef Ptr<const ObjectGui> ConstObjectGuiPtr;
typedef const ObjectGui ConstObjectGui;
...
{
public:
	typedef const ObjectGuiMesh ConstObjectGuiMesh;
...
typedef Ptr<const ObjectGuiMesh> ConstObjectGuiMeshPtr;
typedef const ObjectGuiMesh ConstObjectGuiMesh;
...
{
public:
	typedef const ObjectWaterMesh ConstObjectWaterMesh;

	static Node::TYPE type() { return Node::OBJECT_WATER_MESH; }
	static bool convertible(Node *node) { return (node && node->getType() == type()); }

	static Ptr<ObjectWaterMesh> create();
	static Ptr<ObjectWaterMesh> create(const Ptr<ConstMesh> &mesh);
...
typedef Ptr<const ObjectWaterMesh> ConstObjectWaterMeshPtr;
typedef const ObjectWaterMesh ConstObjectWaterMesh;
...
{
public:
	typedef const ObjectText ConstObjectText;
...
typedef Ptr<const ObjectText> ConstObjectTextPtr;
typedef const ObjectText ConstObjectText;
...
{
public:
	typedef const ObjectWaterGlobal ConstObjectWaterGlobal;
...
typedef Ptr<const ObjectWaterGlobal> ConstObjectWaterGlobalPtr;
typedef const ObjectWaterGlobal ConstObjectWaterGlobal;
...
{
public:
	typedef const ObjectCloudLayer ConstObjectCloudLayer;
...
typedef Ptr<const ObjectCloudLayer> ConstObjectCloudLayerPtr;
typedef const ObjectCloudLayer ConstObjectCloudLayer;
...
{
public:
	typedef const ObjectExtern ConstObjectExtern;
...
typedef Ptr<const ObjectExtern> ConstObjectExternPtr;
typedef const ObjectExtern ConstObjectExtern;
...
{
public:
typedef const ObjectExternBase ConstObjectExternBase;
	ObjectExternBase();
...
typedef Ptr<const ObjectExternBase> ConstObjectExternBasePtr;
typedef const ObjectExternBase ConstObjectExternBase;
