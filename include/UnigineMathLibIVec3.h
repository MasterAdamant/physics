...
UNIGINE_INLINE bool compare(const ivec3 &v0, const ivec3 &v1) { return v0._hash.xy == v1._hash.xy && v0._hash.z == v1._hash.z; }
/// <summary>Vector equal comparison.</summary>
UNIGINE_INLINE bool operator==(const ivec3 &v0, const ivec3 &v1) { return compare(v0, v1); }
/// <summary>Vector not equal comparison.</summary>
UNIGINE_INLINE bool operator!=(const ivec3 &v0, const ivec3 &v1) { return !compare(v0, v1); }

/// <summary>Vector less than comparison.</summary>
UNIGINE_INLINE bool operator<(const ivec3 &v0, const ivec3 &v1) { return v0.x < v1.x && v0.y < v1.y && v0.z < v1.z; }
