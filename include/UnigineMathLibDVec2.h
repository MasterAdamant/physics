...
UNIGINE_INLINE bool compare(const dvec2 &v0, const dvec2 &v1)
{
...
UNIGINE_INLINE bool compare(const dvec2 &v0, const dvec2 &v1, double eps)
{
	return (compare(v0.x, v1.x, eps) && compare(v0.y, v1.y, eps));
}
/// <summary>Vector equal comparison.</summary>
UNIGINE_INLINE bool operator==(const dvec2 &v0, const dvec2 &v1) { return compare(v0, v1); }
/// <summary>Vector not equal comparison.</summary>
UNIGINE_INLINE bool operator!=(const dvec2 &v0, const dvec2 &v1) { return !compare(v0, v1); }

/// <summary>Vector less than comparison.</summary>
UNIGINE_INLINE bool operator<(const dvec2 &v0, const dvec2 &v1) { return v0.x < v1.x &&v0.y < v1.y; }
