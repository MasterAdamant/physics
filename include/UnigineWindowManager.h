...
{
public:
	typedef const EngineWindow ConstEngineWindow;
...
typedef Ptr<const EngineWindow> ConstEngineWindowPtr;
typedef const EngineWindow ConstEngineWindow;
...
{
public:
typedef const EngineWindowViewport ConstEngineWindowViewport;
...
typedef Ptr<const EngineWindowViewport> ConstEngineWindowViewportPtr;
typedef const EngineWindowViewport ConstEngineWindowViewport;
...
{
public:
typedef const EngineWindowGroup ConstEngineWindowGroup;
...
typedef Ptr<const EngineWindowGroup> ConstEngineWindowGroupPtr;
typedef const EngineWindowGroup ConstEngineWindowGroup;
...
{
public:
	typedef const WindowEvent ConstWindowEvent;
...
typedef Ptr<const WindowEvent> ConstWindowEventPtr;
typedef const WindowEvent ConstWindowEvent;
...
{
public:
typedef const WindowEventGeneric ConstWindowEventGeneric;
...
typedef Ptr<const WindowEventGeneric> ConstWindowEventGenericPtr;
typedef const WindowEventGeneric ConstWindowEventGeneric;
...
{
public:
typedef const WindowEventDrop ConstWindowEventDrop;
...
typedef Ptr<const WindowEventDrop> ConstWindowEventDropPtr;
typedef const WindowEventDrop ConstWindowEventDrop;
...
{
public:
typedef const WindowEventDpi ConstWindowEventDpi;
...
typedef Ptr<const WindowEventDpi> ConstWindowEventDpiPtr;
typedef const WindowEventDpi ConstWindowEventDpi;
...
{
public:
	typedef const SystemDialog ConstSystemDialog;
	static constexpr bool HAS_OWNERSHIP = true;
...
typedef Ptr<const SystemDialog> ConstSystemDialogPtr;
typedef const SystemDialog ConstSystemDialog;
