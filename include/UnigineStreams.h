...
{
public:
	typedef const Stream ConstStream;
...
typedef Ptr<const Stream> ConstStreamPtr;
typedef const Stream ConstStream;
...
typedef Ptr<const File> ConstFilePtr;
typedef const File ConstFile;
...
typedef Ptr<const Blob> ConstBlobPtr;
typedef const Blob ConstBlob;
...
{
public:
typedef const Socket ConstSocket;
...
typedef Ptr<const Socket> ConstSocketPtr;
typedef const Socket ConstSocket;
