...
struct IEEE754
{
	using cast_t = typename std::conditional<std::is_same<T, float>::value, uint32_t, uint64_t>::type;
	enum : size_t
	{
		SIGN_WIDTH = 1,
		EXPONENT_WIDTH = std::is_same<T, float>::value ? 8 : 11,
		MANTISSA_WIDTH = std::is_same<T, float>::value ? 23 : 52
	};

	enum : cast_t
	{
		FULL_MASK = ~cast_t(0),
		SIGN_MASK = cast_t(1) << (sizeof(cast_t) * 8 - 1),
		EXPONENT_MASK = (FULL_MASK << MANTISSA_WIDTH) ^ SIGN_MASK,
		MANTISSA_MASK = FULL_MASK >> (SIGN_WIDTH + EXPONENT_WIDTH)
	};

	UNIGINE_INLINE static bool isNan(T value)
	{
		cast_t v = *reinterpret_cast<cast_t *>(&value);
		return ((v & EXPONENT_MASK) == EXPONENT_MASK) && (v & MANTISSA_MASK) != 0;
	}
	UNIGINE_INLINE static bool isInf(T value)
	{
		cast_t v = *reinterpret_cast<cast_t *>(&value);
		return ((v & EXPONENT_MASK) == EXPONENT_MASK) && (v & MANTISSA_MASK) == 0;
	}
	UNIGINE_INLINE static bool isFinite(T value)
	{
		cast_t v = *reinterpret_cast<cast_t *>(&value);
		return (v & EXPONENT_MASK) != EXPONENT_MASK;
	}
};
...
UNIGINE_INLINE float doubleHalfToFloat(half a1, half a2)
{
	...
	result.a1 = *reinterpret_cast<unsigned short *>(&a1);
	result.a2 = *reinterpret_cast<unsigned short *>(&a2);
...
template<typename T, std::enable_if_t<std::is_convertible<T, float>::value, int> = 0>
...
template<typename T, std::enable_if_t<std::is_convertible<T, double>::value, int> = 0>
...
template<typename T, std::enable_if_t<std::is_convertible<T, Scalar>::value, int> = 0>
...
template<typename T, std::enable_if_t<std::is_convertible<T, int>::value, int> = 0>
...
template<typename T, std::enable_if_t<std::is_convertible<T, unsigned int>::value, int> = 0>
...
template<typename T, std::enable_if_t<std::is_convertible<T, char>::value, int> = 0>
...
template<typename T, std::enable_if_t<std::is_convertible<T, short>::value, int> = 0>
...
template<typename T, std::enable_if_t<std::is_convertible<T, unsigned char>::value, int> = 0>
...
template<typename T, std::enable_if_t<std::is_convertible<T, unsigned short>::value, int> = 0>
...
template<typename T, std::enable_if_t<std::is_convertible<T, unsigned long long>::value, int> = 0>
...
template<typename T, std::enable_if_t<std::is_convertible<T, long long>::value, int> = 0>
...
template<typename T, std::enable_if_t<std::is_convertible<T, int>::value, int> = 0> // pointers are convertible to bool, so use int
...
{
public:
	static constexpr int Capacity = sizeof(Type) * 8;
	...
	UNIGINE_INLINE int size() const { return Capacity; }
	/// <summary>Clears the structure.</summary>
	UNIGINE_INLINE void clear() { data = 0; }

	Type data{0};
};
using Bits8 = Bits<char>;
using Bits16 = Bits<short>;
using Bits32 = Bits<int>;
using Bits64 = Bits<long long>;
...
{
	return Consts::PI05 - (((((((-0.0012624911f * v + 0.0066700901f) * v - 0.0170881256f) * v + 0.0308918810f) * v - 0.0501743046f) * v + 0.0889789874f) * v - 0.2145988016f) * v + 1.5707963050f) * sqrt(1.0f - v);
}
...
{
	return (((((((-0.0012624911f * v + 0.0066700901f) * v - 0.0170881256f) * v + 0.0308918810f) * v - 0.0501743046f) * v + 0.0889789874f) * v - 0.2145988016f) * v + 1.5707963050f) * sqrt(1.0f - v);
}
...
{
	unsigned int bits = ((*reinterpret_cast<unsigned int *>(&v)) & 0x80000000) | 0x3f800000;
...
/// <summary>Returns the squared argument (raised to the power of 3).</summary>
UNIGINE_INLINE float pow3(float x) { return x * x * x; }
/// <summary>Returns the squared argument (raised to the power of 3).</summary>
UNIGINE_INLINE double pow3(double x) { return x * x * x; }
/// <summary>Returns the squared argument (raised to the power of 3).</summary>
UNIGINE_INLINE int pow3(int x) { return x * x * x; }

/// <summary>Returns the squared argument (raised to the power of 4).</summary>
UNIGINE_INLINE float pow4(float x) { return x * x * x * x; }
/// <summary>Returns the squared argument (raised to the power of 4).</summary>
UNIGINE_INLINE double pow4(double x) { return x * x * x * x; }
/// <summary>Returns the squared argument (raised to the power of 4).</summary>
UNIGINE_INLINE int pow4(int x) { return x * x * x * x; }
...
/// <summary>Converts RGB color value to sRGB format.</summary>
UNIGINE_INLINE double srgb(double x) { return pow(x, 2.2); }
/// <summary>Converts sRGB color value to RGB format.</summary>
UNIGINE_INLINE double isrgb(double x) { return pow(x, 1.0f / 2.2); }
...
/// <summary>Compares the arguments and returns the minimum value.</summary>
UNIGINE_INLINE unsigned int min(unsigned int v0, unsigned int v1) { return (v0 < v1) ? v0 : v1; }
/// <summary>Compares the arguments and returns the minimum value.</summary>
UNIGINE_INLINE short min(short v0, short v1) { return (v0 < v1) ? v0 : v1; }
/// <summary>Compares the arguments and returns the minimum value.</summary>
UNIGINE_INLINE unsigned short min(unsigned short v0, unsigned short v1) { return (v0 < v1) ? v0 : v1; }
/// <summary>Compares the arguments and returns the minimum value.</summary>
UNIGINE_INLINE char min(char v0, char v1) { return (v0 < v1) ? v0 : v1; }
/// <summary>Compares the arguments and returns the minimum value.</summary>
UNIGINE_INLINE unsigned char min(unsigned char v0, unsigned char v1) { return (v0 < v1) ? v0 : v1; }
/// <summary>Compares the arguments and returns the minimum value.</summary>
...
#ifdef _WIN32
static_assert(sizeof(unsigned long int) == sizeof(unsigned int), "size must be expected");
/// <summary>Compares the arguments and returns the minimum value.</summary>
UNIGINE_INLINE unsigned long int min(unsigned long int v0, unsigned long int v1) { return (v0 < v1) ? v0 : v1; }
#else
static_assert(sizeof(unsigned long int) == sizeof(unsigned long long), "size must be expected");
/// <summary>Compares the arguments and returns the minimum value.</summary>
UNIGINE_INLINE unsigned long long min(unsigned long long v0, unsigned long long v1) { return (v0 < v1) ? v0 : v1; }
#endif
...
/// <summary>Compares the arguments and returns the maximum value.</summary>
UNIGINE_INLINE unsigned int max(unsigned int v0, unsigned int v1) { return (v0 > v1) ? v0 : v1; }
/// <summary>Compares the arguments and returns the maximum value.</summary>
UNIGINE_INLINE short max(short v0, short v1) { return (v0 > v1) ? v0 : v1; }
/// <summary>Compares the arguments and returns the maximum value.</summary>
UNIGINE_INLINE unsigned short max(unsigned short v0, unsigned short v1) { return (v0 > v1) ? v0 : v1; }
/// <summary>Compares the arguments and returns the maximum value.</summary>
UNIGINE_INLINE char max(char v0, char v1) { return (v0 > v1) ? v0 : v1; }
/// <summary>Compares the arguments and returns the maximum value.</summary>
UNIGINE_INLINE unsigned char max(unsigned char v0, unsigned char v1) { return (v0 > v1) ? v0 : v1; }
/// <summary>Compares the arguments and returns the maximum value.</summary>
...
static_assert(sizeof(unsigned long int) == sizeof(unsigned int), "size must be expected");
/// <summary>Compares the arguments and returns the maximum value.</summary>
UNIGINE_INLINE unsigned long int max(unsigned long int v0, unsigned long int v1) { return (v0 > v1) ? v0 : v1; }
#else
static_assert(sizeof(unsigned long int) == sizeof(unsigned long long), "size must be expected");
/// <summary>Compares the arguments and returns the maximum value.</summary>
UNIGINE_INLINE unsigned long long max(unsigned long long v0, unsigned long long v1) { return (v0 > v1) ? v0 : v1; }
#endif
...
/// <summary>Returns the value clamped within the specified v0 and v1 limits.</summary>
UNIGINE_INLINE unsigned int clamp(unsigned int v, unsigned int v0, unsigned int v1) { return (v < v0) ? v0 : ((v > v1) ? v1 : v); }
/// <summary>Returns the value clamped within the specified v0 and v1 limits.</summary>
UNIGINE_INLINE short clamp(short v, short v0, short v1) { return (v < v0) ? v0 : ((v > v1) ? v1 : v); }
/// <summary>Returns the value clamped within the specified v0 and v1 limits.</summary>
UNIGINE_INLINE unsigned short clamp(unsigned short v, unsigned short v0, unsigned short v1) { return (v < v0) ? v0 : ((v > v1) ? v1 : v); }
/// <summary>Returns the value clamped within the specified v0 and v1 limits.</summary>
UNIGINE_INLINE char clamp(char v, char v0, char v1) { return (v < v0) ? v0 : ((v > v1) ? v1 : v); }
/// <summary>Returns the value clamped within the specified v0 and v1 limits.</summary>
UNIGINE_INLINE unsigned char clamp(unsigned char v, unsigned char v0, unsigned char v1) { return (v < v0) ? v0 : ((v > v1) ? v1 : v); }
/// <summary>Returns the value clamped within the specified v0 and v1 limits.</summary>
...
static_assert(sizeof(unsigned long int) == sizeof(unsigned int), "size must be expected");
/// <summary>Returns the value clamped within the specified v0 and v1 limits.</summary>
UNIGINE_INLINE unsigned long int clamp(unsigned long int v, unsigned long int v0, unsigned long int v1) { return (v < v0) ? v0 : ((v > v1) ? v1 : v); }
#else
static_assert(sizeof(unsigned long int) == sizeof(unsigned long long), "size must be expected");
/// <summary>Returns the value clamped within the specified v0 and v1 limits.</summary>
UNIGINE_INLINE unsigned long long clamp(unsigned long long v, unsigned long long v0, unsigned long long v1) { return (v < v0) ? v0 : ((v > v1) ? v1 : v); }
#endif
...
/// <summary>Checks whether the value a is greater than or equal to b.</summary>
UNIGINE_INLINE bool step(double a, double b) { return a >= b; }
...
/// <summary>Performs overlay A over B with blending coefficient.</summary>
UNIGINE_INLINE double overlay(double a, double b, double x) { return max(lerp(a, lerp(1.0 - 2.0 * (1.0 - a) * (1.0 - b), 2.0 * a * b, toDouble(step(a, 0.5))), x), 0.0); }
...
/// <summary>Normalizes an input angle to the range (−180, 180).</summary>
UNIGINE_INLINE double normalizeAngle(double angle)
{
	if (angle > 180.0)
...
constexpr auto align(long long value, long long align) { return (value % align) ? value + align - value % align : value; }
constexpr auto align(int value, int align) { return (value % align) ? value + align - value % align : value; }
constexpr auto align(short value, short align) { return (value % align) ? value + align - value % align : value; }
constexpr auto align(char value, char align) { return (value % align) ? value + align - value % align : value; }
constexpr auto align(unsigned long long value, unsigned long long align) { return (value % align) ? value + align - value % align : value; }
constexpr auto align(unsigned int value, unsigned int align) { return (value % align) ? value + align - value % align : value; }
constexpr auto align(unsigned short value, unsigned short align) { return (value % align) ? value + align - value % align : value; }
constexpr auto align(unsigned char value, unsigned char align) { return (value % align) ? value + align - value % align : value; }
...
UNIGINE_INLINE A makeAligned(A location, B align_value)
{
...
// SSE
#ifdef USE_SSE
static const __m128 _mm_one_ps = _mm_set_ps1(1.0f);
static const __m128 _mm_zero_ps = _mm_set_ps1(0.0f);
static const __m128 _mm_nzero_ps = _mm_set_ps1(-0.0f);
static const __m128 _mm_half_ps = _mm_set_ps1(0.5f);

static const __m128d _mm_one_pd = _mm_set1_pd(1.0);
static const __m128d _mm_zero_pd = _mm_set1_pd(0.0);
static const __m128d _mm_nzero_pd = _mm_set1_pd(-0.0);
static const __m128d _mm_half_pd = _mm_set1_pd(0.5);

UNIGINE_INLINE __m128 _mm_mad_ps(__m128 v0, __m128 v1, __m128 v2) { return _mm_add_ps(_mm_mul_ps(v0, v1), v2); }

UNIGINE_INLINE __m128 _mm_xyz_ps(__m128 v0, __m128 v1) { return _mm_blend_ps(v0, v1, 0x7); }
UNIGINE_INLINE float _mm_cast_f(__m128 v0) { return _mm_cvtss_f32(v0); }

UNIGINE_INLINE __m128 _mm_nearest_round_ps(__m128 v0) { return _mm_round_ps(v0, _MM_FROUND_NINT); }

UNIGINE_INLINE __m128 _mm_frac_ps(__m128 v) { return _mm_sub_ps(v, _mm_round_ps(v, _MM_FROUND_TRUNC)); }

UNIGINE_INLINE __m128 _mm_abs_ps(__m128 x) { return _mm_andnot_ps(_mm_nzero_ps, x); }
UNIGINE_INLINE __m128d _mm_abs_pd(__m128d x) { return _mm_andnot_pd(_mm_nzero_pd, x); }

UNIGINE_INLINE __m128 _mm_rcp_stric_ps(__m128 x) { return _mm_div_ps(_mm_one_ps, x); }
UNIGINE_INLINE __m128d _mm_rcp_stric_pd(__m128d x) { return _mm_div_pd(_mm_one_pd, x); }

UNIGINE_INLINE __m128 _mm_rsqrt_stric_ps(__m128 x) { return _mm_div_ps(_mm_one_ps, _mm_sqrt_ps(x)); }
UNIGINE_INLINE __m128d _mm_rsqrt_stric_pd(__m128d x) { return _mm_div_pd(_mm_one_pd, _mm_sqrt_pd(x)); }

UNIGINE_INLINE __m128 _mm_min_ps1(__m128 v0, float v1) { return _mm_min_ps(v0, _mm_set_ps1(v1)); }
UNIGINE_INLINE __m128 _mm_max_ps1(__m128 v0, float v1) { return _mm_max_ps(v0, _mm_set_ps1(v1)); }
UNIGINE_INLINE __m128 _mm_clamp_ps(__m128 v, __m128 v0, __m128 v1) { return _mm_min_ps(_mm_max_ps(v, v0), v1); }

UNIGINE_INLINE __m128 _mm_sum_ps(__m128 v)
{
...
UNIGINE_INLINE float _mm_sum_ps_f(__m128 v) { return _mm_cast_f(_mm_sum_ps(v)); }

UNIGINE_INLINE __m128 _mm_lerp_ps(__m128 v0, __m128 v1, __m128 k) { return _mm_mad_ps(_mm_sub_ps(v1, v0), k, v0); }
UNIGINE_INLINE __m128 _mm_ilerp_ps(__m128 v0, __m128 v1, __m128 k) { return _mm_div_ps(_mm_sub_ps(k, v0), _mm_sub_ps(v1, v0)); }
UNIGINE_INLINE __m128 _mm_lerp_ps1(__m128 v0, __m128 v1, float k) { return _mm_lerp_ps(v1, v0, _mm_set_ps1(k)); }
...
UNIGINE_INLINE __m128 _mm_dot3(__m128 v0, __m128 v1) { return _mm_dp_ps(v0, v1, 0x7f); }
UNIGINE_INLINE __m128 _mm_dot4(__m128 v0, __m128 v1) { return _mm_dp_ps(v0, v1, 0xff); }

UNIGINE_INLINE __m128 _mm_length2_ps3(__m128 v) { return _mm_dot3(v, v); }
UNIGINE_INLINE __m128 _mm_length2_ps4(__m128 v) { return _mm_dot4(v, v); }

UNIGINE_INLINE __m128 _mm_length_ps3(__m128 v) { return _mm_sqrt_ss(_mm_length2_ps3(v)); }
UNIGINE_INLINE __m128 _mm_length_ps4(__m128 v) { return _mm_sqrt_ss(_mm_length2_ps4(v)); }

UNIGINE_INLINE __m128 _mm_ilength_fast_ps3(__m128 v) { return _mm_rsqrt_ss(_mm_length2_ps3(v)); }
UNIGINE_INLINE __m128 _mm_ilength_fast_ps4(__m128 v) { return _mm_rsqrt_ss(_mm_length2_ps4(v)); }

UNIGINE_INLINE __m128 _mm_length_fast_ps3(__m128 v) { return _mm_rcp_ss(_mm_ilength_fast_ps3(v)); }
UNIGINE_INLINE __m128 _mm_length_fast_ps4(__m128 v) { return _mm_rcp_ss(_mm_ilength_fast_ps4(v)); }

UNIGINE_INLINE __m128 _mm_distance_ps3(__m128 v0, __m128 v1) { return _mm_length_ps3(_mm_sub_ps(v0, v1)); }
UNIGINE_INLINE __m128 _mm_distance_ps4(__m128 v0, __m128 v1) { return _mm_length_ps4(_mm_sub_ps(v0, v1)); }

UNIGINE_INLINE __m128 _mm_distance_fast_ps3(__m128 v0, __m128 v1) { return _mm_length_fast_ps3(_mm_sub_ps(v0, v1)); }
UNIGINE_INLINE __m128 _mm_distance_fast_ps4(__m128 v0, __m128 v1) { return _mm_length_fast_ps4(_mm_sub_ps(v0, v1)); }

UNIGINE_INLINE __m128 _mm_distance2_ps3(__m128 v0, __m128 v1) { return _mm_length2_ps3(_mm_sub_ps(v0, v1)); }
UNIGINE_INLINE __m128 _mm_distance2_ps4(__m128 v0, __m128 v1) { return _mm_length2_ps4(_mm_sub_ps(v0, v1)); }

UNIGINE_INLINE float _mm_dot3_f(__m128 v0, __m128 v1) { return _mm_cast_f(_mm_dot3(v0, v1)); }
UNIGINE_INLINE float _mm_dot4_f(__m128 v0, __m128 v1) { return _mm_cast_f(_mm_dot4(v0, v1)); }

UNIGINE_INLINE float _mm_length2_ps3_f(__m128 v) { return _mm_cast_f(_mm_length2_ps3(v)); }
UNIGINE_INLINE float _mm_length2_ps4_f(__m128 v) { return _mm_cast_f(_mm_length2_ps4(v)); }

UNIGINE_INLINE float _mm_length_ps3_f(__m128 v) { return _mm_cast_f(_mm_length_ps3(v)); }
UNIGINE_INLINE float _mm_length_ps4_f(__m128 v) { return _mm_cast_f(_mm_length_ps4(v)); }

UNIGINE_INLINE float _mm_ilength_ps3_f(__m128 v) { return 1.0f / _mm_cast_f(_mm_length_ps3(v)); }
UNIGINE_INLINE float _mm_ilength_ps4_f(__m128 v) { return 1.0f / _mm_cast_f(_mm_length_ps4(v)); }

UNIGINE_INLINE float _mm_ilength_fast_ps3_f(__m128 v) { return _mm_cast_f(_mm_ilength_fast_ps3(v)); }
UNIGINE_INLINE float _mm_ilength_fast_ps4_f(__m128 v) { return _mm_cast_f(_mm_ilength_fast_ps4(v)); }

UNIGINE_INLINE float _mm_length_fast_ps3_f(__m128 v) { return _mm_cast_f(_mm_length_fast_ps3(v)); }
UNIGINE_INLINE float _mm_length_fast_ps4_f(__m128 v) { return _mm_cast_f(_mm_length_fast_ps4(v)); }

UNIGINE_INLINE float _mm_distance_ps3_f(__m128 v0, __m128 v1) { return _mm_cast_f(_mm_distance_ps3(v0, v1)); }
UNIGINE_INLINE float _mm_distance_ps4_f(__m128 v0, __m128 v1) { return _mm_cast_f(_mm_distance_ps4(v0, v1)); }

UNIGINE_INLINE float _mm_distance_fast_ps3_f(__m128 v0, __m128 v1) { return _mm_cast_f(_mm_distance_fast_ps3(v0, v1)); }
UNIGINE_INLINE float _mm_distance_fast_ps4_f(__m128 v0, __m128 v1) { return _mm_cast_f(_mm_distance_fast_ps4(v0, v1)); }

UNIGINE_INLINE float _mm_distance2_ps3_f(__m128 v0, __m128 v1) { return _mm_cast_f(_mm_distance2_ps3(v0, v1)); }
UNIGINE_INLINE float _mm_distance2_ps4_f(__m128 v0, __m128 v1) { return _mm_cast_f(_mm_distance2_ps4(v0, v1)); }

UNIGINE_INLINE __m128 _mm_normalize_fast_ps3(__m128 v)
{
	return _mm_mul_ps(v, _MM_SWIZZLE(_mm_rsqrt_ss(_mm_dp_ps(v, v, 0x7f)), X, X, X, X));
}
UNIGINE_INLINE __m128 _mm_normalize_fast_ps4(__m128 v)
{
	return _mm_mul_ps(v, _MM_SWIZZLE(_mm_rsqrt_ss(_mm_dp_ps(v, v, 0xff)), X, X, X, X));
}

UNIGINE_INLINE __m128 _mm_normalize_ps3(__m128 v)
{
	return _mm_div_ps(v, _MM_SWIZZLE(_mm_sqrt_ss(_mm_dp_ps(v, v, 0x7f)), X, X, X, X));
}
UNIGINE_INLINE __m128 _mm_normalize_ps4(__m128 v)
{
	return _mm_div_ps(v, _MM_SWIZZLE(_mm_sqrt_ss(_mm_dp_ps(v, v, 0xff)), X, X, X, X));
}
...
UNIGINE_INLINE __m128 _mm_sub_ps1(__m128 v0, float v1) { return _mm_sub_ps(v0, _mm_set_ps1(v1)); }
UNIGINE_INLINE __m128 _mm_add_ps1(__m128 v0, float v1) { return _mm_add_ps(v0, _mm_set_ps1(v1)); }
UNIGINE_INLINE __m128 _mm_mul_ps1(__m128 v0, float v1) { return _mm_mul_ps(v0, _mm_set_ps1(v1)); }
UNIGINE_INLINE __m128 _mm_div_ps1(__m128 v0, float v1) { return _mm_mul_ps(v0, _mm_set_ps1(1.0f / v1)); }

UNIGINE_INLINE __m128 _mm_mul3_ps(__m128 v0, __m128 v1) { return _mm_blend_ps(v0, _mm_mul_ps(v0, v1), 0x7); }
UNIGINE_INLINE __m128 _mm_mul3_ps1(__m128 v0, float v1) { return _mm_blend_ps(v0, _mm_mul_ps(v0, _mm_set_ps1(v1)), 0x7); }

UNIGINE_INLINE __m128 _mm_div_fast_ps(__m128 v0, __m128 v1) { return _mm_mul_ps(v0, _mm_rcp_ps(v1)); }
UNIGINE_INLINE __m128 _mm_div_fast_ps1(__m128 v0, float v1) { return _mm_mul_ps(v0, _mm_rcp_ps(_mm_set_ps1(v1))); }

UNIGINE_INLINE __m128 _mm_div3_ps(__m128 v0, __m128 v1) { return _mm_blend_ps(v0, _mm_div_ps(v0, v1), 0x7); }
UNIGINE_INLINE __m128 _mm_div3_ps1(__m128 v0, float v1) { return _mm_blend_ps(v0, _mm_mul_ps(v0, _mm_set_ps1(1.0f / v1)), 0x7); }
UNIGINE_INLINE __m128 _mm_div3_fast_ps(__m128 v0, __m128 v1) { return _mm_blend_ps(v0, _mm_mul_ps(v0, _mm_rcp_ps(v1)), 0x7); }
UNIGINE_INLINE __m128 _mm_div3_fast_ps1(__m128 v0, float v1) { return _mm_blend_ps(v0, _mm_mul_ps(v0, _mm_rcp_ps(_mm_set_ps1(v1))), 0x7); }
