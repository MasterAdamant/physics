...
public:
	...
	UNIGINE_INLINE static LeapMotion *get()
	{
		static LeapMotion *instance = nullptr;
			...
			if (instance == nullptr)
			{
				if (!connection.isValid())
				{
					Engine::get()->getEventPluginRemoved().connect(
						...
						[](const char *name)
						{
							if (String::equal(name, "UnigineLeapMotion"))
							{
								instance = nullptr;
				...
				instance = Unigine::Engine::get()->getPlugin<LeapMotion>("UnigineLeapMotion");
			}
		}
		return instance;
	}
