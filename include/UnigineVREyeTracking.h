...
public:
	...
	static float getIPD();
	static long long getCaptureTime();
	...
	static bool hasFeatureRequestCalibration();
	static bool hasFeaturePupilDiameter();
	static bool hasFeatureIrisDiameter();
	static bool hasFeaturePupilIrisDiameterRatio();
	static bool hasFeatureOpenness();
};
