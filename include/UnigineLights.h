...
{
public:
	typedef const LightLensFlare ConstLightLensFlare;
...
typedef Ptr<const LightLensFlare> ConstLightLensFlarePtr;
typedef const LightLensFlare ConstLightLensFlare;
...
typedef Ptr<const Light> ConstLightPtr;
typedef const Light ConstLight;
...
{
public:
	typedef const LightVoxelProbe ConstLightVoxelProbe;
	...
	void setSpecularVisibilityRoughnessMin(float val);
	float getSpecularVisibilityRoughnessMin() const;
	void setSpecularVisibilityRoughnessMax(float val);
...
typedef Ptr<const LightVoxelProbe> ConstLightVoxelProbePtr;
typedef const LightVoxelProbe ConstLightVoxelProbe;
...
{
public:
	typedef const LightEnvironmentProbe ConstLightEnvironmentProbe;
...
typedef Ptr<const LightEnvironmentProbe> ConstLightEnvironmentProbePtr;
typedef const LightEnvironmentProbe ConstLightEnvironmentProbe;
...
{
public:
	typedef const LightPlanarProbe ConstLightPlanarProbe;
...
typedef Ptr<const LightPlanarProbe> ConstLightPlanarProbePtr;
typedef const LightPlanarProbe ConstLightPlanarProbe;
...
{
public:
	typedef const LightOmni ConstLightOmni;
...
typedef Ptr<const LightOmni> ConstLightOmniPtr;
typedef const LightOmni ConstLightOmni;
...
{
public:
	typedef const LightProj ConstLightProj;
...
typedef Ptr<const LightProj> ConstLightProjPtr;
typedef const LightProj ConstLightProj;
...
{
public:
	typedef const LightWorld ConstLightWorld;
...
typedef Ptr<const LightWorld> ConstLightWorldPtr;
typedef const LightWorld ConstLightWorld;
