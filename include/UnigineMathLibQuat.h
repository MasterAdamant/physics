...
UNIGINE_INLINE bool compare(const quat &q0, const quat &q1)
{
...
UNIGINE_INLINE bool compare(const quat &q0, const quat &q1, float epsilon)
{
...
UNIGINE_INLINE bool operator==(const quat &q0, const quat &q1) { return compare(q0, q1); }
