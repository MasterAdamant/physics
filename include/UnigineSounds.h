...
{
public:
	typedef const AmbientSource ConstAmbientSource;
...
typedef Ptr<const AmbientSource> ConstAmbientSourcePtr;
typedef const AmbientSource ConstAmbientSource;
...
{
public:
	typedef const SoundSource ConstSoundSource;
...
typedef Ptr<const SoundSource> ConstSoundSourcePtr;
typedef const SoundSource ConstSoundSource;
...
{
public:
	typedef const SoundReverb ConstSoundReverb;
...
typedef Ptr<const SoundReverb> ConstSoundReverbPtr;
typedef const SoundReverb ConstSoundReverb;
