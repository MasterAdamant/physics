...
public:
	...
	static void renderMesh(const Ptr<MeshRender> &mesh, const Math::Mat4 &transform, const Math::vec4 &color, float duration = 0.0f, bool depth_test = true);
	static void renderMesh(const UGUID &mesh_guid, const Math::Mat4 &transform, const Math::vec4 &color, float duration = 0.0f, bool depth_test = true);
	static void renderMesh(const char *path, const Math::Mat4 &transform, const Math::vec4 &color, float duration = 0.0f, bool depth_test = true);
	static void renderSolidMesh(const Ptr<MeshRender> &mesh, const Math::Mat4 &transform, const Math::vec4 &color, float duration = 0.0f, bool depth_test = true);
	static void renderSolidMesh(const UGUID &mesh_guid, const Math::Mat4 &transform, const Math::vec4 &color, float duration = 0.0f, bool depth_test = true);
	static void renderSolidMesh(const char *path, const Math::Mat4 &transform, const Math::vec4 &color, float duration = 0.0f, bool depth_test = true);
};
