...
{
public:
	typedef const Player ConstPlayer;
...
typedef Ptr<const Player> ConstPlayerPtr;
typedef const Player ConstPlayer;
...
{
public:
	typedef const PlayerDummy ConstPlayerDummy;
...
typedef Ptr<const PlayerDummy> ConstPlayerDummyPtr;
typedef const PlayerDummy ConstPlayerDummy;
...
{
public:
	typedef const PlayerActor ConstPlayerActor;
...
typedef Ptr<const PlayerActor> ConstPlayerActorPtr;
typedef const PlayerActor ConstPlayerActor;
...
{
public:
	typedef const PlayerPersecutor ConstPlayerPersecutor;
...
typedef Ptr<const PlayerPersecutor> ConstPlayerPersecutorPtr;
typedef const PlayerPersecutor ConstPlayerPersecutor;
...
{
public:
	typedef const PlayerSpectator ConstPlayerSpectator;
...
typedef Ptr<const PlayerSpectator> ConstPlayerSpectatorPtr;
typedef const PlayerSpectator ConstPlayerSpectator;
