...
UNIGINE_INLINE bool compare(const svec4 &v0, const svec4 &v1) { return v0.long_v == v1.long_v; }
/// <summary>Vector equal comparison.</summary>
UNIGINE_INLINE bool operator==(const svec4 &v0, const svec4 &v1) { return v0.long_v == v1.long_v; }
