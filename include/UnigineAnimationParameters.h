...
public:
	...
	enum PARAM
	{
		...
		PARAM_LIGHT__ORDER, // light.order Int
		...
		PARAM_LIGHT_ENVIRONMENT_PROBE__GRAB_BAKE_VISIBILITY_CLOUDS, // light_environment_probe.grab_bake_visibility_clouds Bool
		...
		PARAM_LIGHT_ENVIRONMENT_PROBE__GRAB_BAKE_VISIBILITY_HAZE, // light_environment_probe.grab_bake_visibility_haze Bool
		...
		PARAM_LIGHT_ENVIRONMENT_PROBE__RENDER_ABOVE_VOXEL_PROBES, // light_environment_probe.render_above_voxel_probes Bool
		...
		PARAM_LIGHT_VOXEL_PROBE__DIFFUSE_CUBIC_FILTERING, // light_voxel_probe.diffuse_cubic_filtering Bool
		PARAM_LIGHT_VOXEL_PROBE__DIFFUSE_NORMAL_BIAS, // light_voxel_probe.diffuse_normal_bias Float
		PARAM_LIGHT_VOXEL_PROBE__DIFFUSE_TANGENT_BIAS, // light_voxel_probe.diffuse_tangent_bias Float
		PARAM_LIGHT_VOXEL_PROBE__DIFFUSE_TRANSLUCENT_INDIRECT, // light_voxel_probe.diffuse_translucent_indirect Float
		PARAM_LIGHT_VOXEL_PROBE__DIFFUSE_TRANSLUCENT_SOFT_INDIRECT, // light_voxel_probe.diffuse_translucent_soft_indirect Float
		PARAM_LIGHT_VOXEL_PROBE__SPECULAR_CUBIC_FILTERING, // light_voxel_probe.specular_cubic_filtering Bool
		PARAM_LIGHT_VOXEL_PROBE__SPECULAR_ENABLED, // light_voxel_probe.specular_enabled Bool
		PARAM_LIGHT_VOXEL_PROBE__SPECULAR_NORMAL_BIAS, // light_voxel_probe.specular_normal_bias Float
		PARAM_LIGHT_VOXEL_PROBE__SPECULAR_REFLECTION_BIAS, // light_voxel_probe.specular_reflection_bias Float
		PARAM_LIGHT_VOXEL_PROBE__SPECULAR_TANGENT_BIAS, // light_voxel_probe.specular_tangent_bias Float
		PARAM_LIGHT_VOXEL_PROBE__SPECULAR_VISIBILITY_ROUGHNESS_MAX, // light_voxel_probe.specular_visibility_roughness_max Float
		PARAM_LIGHT_VOXEL_PROBE__SPECULAR_VISIBILITY_ROUGHNESS_MIN, // light_voxel_probe.specular_visibility_roughness_min Float
		...
		// Material
		PARAM_MATERIAL__BLEND_ALPHA_SRC_FUNC, // material.blend_alpha_src_func Int
		...
		PARAM_MATERIAL__ORDER_CLOUDS, // material.order_clouds Int
		...
		PARAM_RENDER__INDIRECT_SPECULAR_NORMALIZATION, // render.indirect_specular_normalization Bool
		...
		PARAM_RENDER__REFLECTION_DYNAMIC_ALPHA_FADE, // render.reflection_dynamic_alpha_fade Bool
		...
		PARAM_RENDER__SHARPEN_BLUR_COLOR_THRESHOLD, // render.sharpen_blur_color_threshold Float
		PARAM_RENDER__SHARPEN_BLUR_DARK_COLOR_THRESHOLD_BIAS, // render.sharpen_blur_dark_color_threshold_bias Float
		PARAM_RENDER__SHARPEN_BLUR_RADIUS, // render.sharpen_blur_radius Int
		PARAM_RENDER__SHARPEN_BLUR_SIGMA, // render.sharpen_blur_sigma Float
		PARAM_RENDER__SHARPEN_DIAGONAL_SAMPLES, // render.sharpen_diagonal_samples Bool
		...
		PARAM_RENDER__STREAMING_CACHE_RAM, // render.streaming_cache_ram Int
		PARAM_RENDER__STREAMING_CACHE_VRAM, // render.streaming_cache_vram Int
		PARAM_RENDER__STREAMING_COMMITTED_MEMORY_OVERCOMMIT, // render.streaming_committed_memory_overcommit Bool
		...
		PARAM_RENDER_STATE__BLEND_ALPHA_SRC_FUNC, // render_state.blend_alpha_src_func Int
		PARAM_RENDER_STATE__BLEND_ALPHA_SRC_FUNC_BUFFER_INDEXED, // render_state.blend_alpha_src_func_buffer_indexed Int
		...
		PARAM_WIDGET_TREE_BOX__STYLE_TEXTURE_SELECTION, // widget_tree_box.style_texture_selection String
		PARAM_WIDGET_TREE_BOX__TEXTURE, // widget_tree_box.texture String

		// WidgetVBox
		PARAM_WIDGET_V_BOX__BACKGROUND, // widget_v_box.background Int
		PARAM_WIDGET_V_BOX__BACKGROUND9_SLICE_SCALE, // widget_v_box.background9_slice_scale Float
		PARAM_WIDGET_V_BOX__BACKGROUND9_SLICED, // widget_v_box.background9_sliced Bool
		...
		PARAM_WIDGET_V_BOX__BACKGROUND_CUSTOM_FILTER, // widget_v_box.background_custom_filter Int
		PARAM_WIDGET_V_BOX__BACKGROUND_CUSTOM_FILTER_ENABLED, // widget_v_box.background_custom_filter_enabled Bool
		PARAM_WIDGET_V_BOX__BACKGROUND_TEXTURE, // widget_v_box.background_texture String
