...
struct alignas(16) dvec4
{
	...
	UNIGINE_INLINE static dvec4 parseColor(const char *str);
...
UNIGINE_INLINE bool compare(const dvec4 &v0, const dvec4 &v1)
{
...
UNIGINE_INLINE bool compare(const dvec4 &v0, const dvec4 &v1, double epsilon)
{
...
UNIGINE_INLINE bool operator==(const dvec4 &v0, const dvec4 &v1) { return compare(v0, v1); }
