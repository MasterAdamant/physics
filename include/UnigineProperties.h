...
{
public:
	typedef const Property ConstProperty;
...
typedef Ptr<const Property> ConstPropertyPtr;
typedef const Property ConstProperty;
...
{
public:
	typedef const PropertyParameter ConstPropertyParameter;
	static constexpr bool HAS_OWNERSHIP = false;
...
typedef Ptr<const PropertyParameter> ConstPropertyParameterPtr;
typedef const PropertyParameter ConstPropertyParameter;
