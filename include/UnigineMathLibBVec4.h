...
UNIGINE_INLINE bool compare(const bvec4 &v0, const bvec4 &v1) { return v0.vec == v1.vec; }
/// <summary>Vector equal comparison.</summary>
UNIGINE_INLINE bool operator==(const bvec4 &v0, const bvec4 &v1) { return v0.vec == v1.vec; }
