...
{
public:
	typedef const Physical ConstPhysical;
...
typedef Ptr<const Physical> ConstPhysicalPtr;
typedef const Physical ConstPhysical;
...
{
public:
	typedef const PhysicalForce ConstPhysicalForce;
...
typedef Ptr<const PhysicalForce> ConstPhysicalForcePtr;
typedef const PhysicalForce ConstPhysicalForce;
...
{
public:
	typedef const PhysicalTrigger ConstPhysicalTrigger;
...
typedef Ptr<const PhysicalTrigger> ConstPhysicalTriggerPtr;
typedef const PhysicalTrigger ConstPhysicalTrigger;
...
{
public:
	typedef const PhysicalWater ConstPhysicalWater;
...
typedef Ptr<const PhysicalWater> ConstPhysicalWaterPtr;
typedef const PhysicalWater ConstPhysicalWater;
...
{
public:
	typedef const PhysicalWind ConstPhysicalWind;
...
typedef Ptr<const PhysicalWind> ConstPhysicalWindPtr;
typedef const PhysicalWind ConstPhysicalWind;
...
{
public:
	typedef const PhysicalNoise ConstPhysicalNoise;
...
typedef Ptr<const PhysicalNoise> ConstPhysicalNoisePtr;
typedef const PhysicalNoise ConstPhysicalNoise;
